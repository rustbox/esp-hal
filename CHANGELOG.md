...
- Removed a Flash-backed LUT for the mapping between CPU interrupt slots and priorites to improve interrupt serivce consistency, latency. Affects RISC-V chips (ESP32-C2, ESP32-C3, ESP32-C6, ESP32-H2) (#TBD)
