...
pub mod dma {
    ...
    use super::{
        Address, Command, DuplexMode, Instance, InstanceDma, IsFullDuplex, IsHalfDuplex, Spi,
        Spi2Instance, SpiDataMode, MAX_DMA_SIZE,
    };
    #[cfg(any(esp32, esp32s2))]
...
mod ehal1 {
    ...
    use embedded_hal_1::spi::{
        self, ErrorType, Operation, SpiBus, SpiBusFlush, SpiBusRead, SpiBusWrite, SpiDevice,
